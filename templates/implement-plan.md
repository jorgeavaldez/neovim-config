...
you are going to implement Phase X of the plan.
...
you should go through and investigate anything that is not clear yourself using the file references in the existing code or by finding them yourself. you may search the web.
